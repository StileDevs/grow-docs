...
Let's start with lowest level of everything. Growtopia is using networking library called [ENet](http://enet.bespin.org/) and this library works as wrapper around UDP connections. You will have to know only basics of ENet and you won't need to know UDP at all as ENet won't give you any access to it.
...
And here are those packet types are listed at [Packet Types](/)
